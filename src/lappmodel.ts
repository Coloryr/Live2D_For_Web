...
import { live2d_view, frameBuffer, gl, LAppDelegate } from './lappdelegate';
...
export class LAppModel extends CubismUserModel {
  ...
  public doDraw(): void {
    ...
    // キャンバスサイズを渡す
    const viewport: number[] = [0, 0, live2d_view.width, live2d_view.height];
   ...
   * コンストラクタ
   */
  public constructor(delegate: LAppDelegate, api: Live2dAPI) {
    super();
    this._api = api;
